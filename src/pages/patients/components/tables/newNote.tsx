        ...
        <div className="grid">
          ...
          {formData.notes.map((note, index) => (
            ...
            >
              ...
              <button
                ...
                className="text-white flex items-center justify-center gap-2 p-3 hover:bg-gray-500 rounded bg-red-500"
              >
          ...
          <div className="flex items-center justify-start">
            <button
              ...
              className="underline my-2 p-2 rounded text-lg text-ha-primary1 w-[auto]"
            >
              Add New Row
            </button>
          </div>
